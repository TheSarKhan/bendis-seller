package com.sarkhan.backend.bendisseller.controller.product;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponseForSelectedSubCategoryAndComplexFilter> getBySubCategoryId(@RequestParam Long subCategoryId) {
